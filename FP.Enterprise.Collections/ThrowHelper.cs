...
namespace FP.Enterprise.Collections
{
  ...
  public static class ThrowHelper
  {
    ...
    {
      throw new ArgumentOutOfRangeException(ThrowHelper.GetArgumentName(ExceptionArgument.index), (ThrowHelper.GetResourceName(ExceptionResource.ArgumentOutOfRange_Index)));
    }
    ...
    {
      throw new ArgumentException(GetResourceName(resource), ThrowHelper.GetArgumentName(argument));
    }
